...
class InstrumentedHashSet1<E> extends HashSet<E> implements InstrumentedSet<E> {
    ...
    public InstrumentedHashSet1(int initCapacity, float loadFactor) {
    ...
    public boolean addAll(Collection<? extends E> c) {
        ...
        addCount += c.size();
        if (DEBUG) System.out.printf("addCount = %d\n", addCount);
